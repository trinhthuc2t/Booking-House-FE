...
const ImageItem = ({file, setImagesFile, setImagesURL, imagesFile, values}) => {
    ...
    const handleDeleteImage = () => {
        setImagePreview("");
        if (imagesFile.length === 1) values.images = "";
    ...
    return (
        <div className={`position-relative d-inline-block image-thumnail ${imagePreview ? '' : 'd-none'}`}>
